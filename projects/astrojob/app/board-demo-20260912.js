...
els.howItWorksButton.onclick=()=>els.howItWorksDialog.showModal();
els.closeHowItWorks.onclick=()=>els.howItWorksDialog.close();
els.howItWorksDialog.onclick=e=>{if(e.target===els.howItWorksDialog)els.howItWorksDialog.close()};
